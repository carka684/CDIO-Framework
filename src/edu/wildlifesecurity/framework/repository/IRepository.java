...
/**
 * A repository component handles storing of data. Data such at logging and
 * configuration.
 * 
 */
public interface IRepository extends IComponent, ILogger {
	 ...
	 * @return
	 */
	ISubscription addEventHandler(EventType type,
	...
	/**
	 * Loads all captures from all trap devices from repository, excluding their
	 * images
	 * 
